    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SellerName = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    StoreName = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    StoreEmail = table.Column<string>(type: "text", nullable: false),
                    StorePhone = table.Column<string>(type: "text", nullable: true),
                    StoreDescription = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZipFileName = table.Column<string>(type: "text", nullable: false),
                    Thumbnail = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CategoryId = table.Column<int>(type: "integer", nullable: false),
                    Price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    UploadDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CGIModel = table.Column<bool>(type: "boolean", nullable: false),
                    Textures = table.Column<bool>(type: "boolean", nullable: false),
                    Materials = table.Column<bool>(type: "boolean", nullable: false),
                    Animated = table.Column<bool>(type: "boolean", nullable: false),
                    Rigged = table.Column<bool>(type: "boolean", nullable: false),
                    LowPoly = table.Column<bool>(type: "boolean", nullable: false),
                    PBR = table.Column<bool>(type: "boolean", nullable: false),
                    UVUnwrapped = table.Column<bool>(type: "boolean", nullable: false),
